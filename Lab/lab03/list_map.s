...
map:
    ...
    # THINK: why a0?
    # because a0 is 'argument' register, we prepare value to the call of the function in s1
    lw a0, 0(s0)

    # Call the function in question on that value. DO NOT use a label (be prepared to answer why).
    # What function? Recall the parameters of "map"
    # No label because the function pointer in s1 can point to any place in memroy, labels assume PC-relative
    # addressing
    jalr ra, s1, 0
